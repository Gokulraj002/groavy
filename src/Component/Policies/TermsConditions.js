  ...
  return (
    <section className="section service" id="service" aria-label="service">
      <div className="container mt-5 text-secondary">
        <h2 className="h2 section-title">Terms and Conditions</h2>
        <p className="section-title">Welcome to Groavy Buildcon!</p>
        <p>
          These terms and conditions outline the rules and regulations for the use of Groavy Buildcon's Website, located
          at <a href="https://groavy.com/">https://groavy.com/</a>. By accessing this website we assume you accept these
          terms and conditions. Do not continue to use Groavy Buildcon if you do not agree to take all of the terms and
        ...
        <p>
          We employ the use of cookies. By accessing Groavy Buildcon, you agreed to use cookies in agreement with the
          Groavy Buildcon's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Groavy Buildcon and/or its licensors own the intellectual property rights for all
          material on Groavy Buildcon. All intellectual property rights are reserved. You may access this from Groavy
          Buildcon for your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Groavy Buildcon</li>
          <li>Sell, rent or sub-license material from Groavy Buildcon</li>
          <li>Reproduce, duplicate or copy material from Groavy Buildcon</li>
          <li>Redistribute content from Groavy Buildcon</li>
        </ul>

        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Groavy Buildcon does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of Groavy Buildcon, its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
          by applicable laws, Groavy Buildcon shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
          this website.
        </p>

        <p>
          Groavy Buildcon reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Groavy Buildcon a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Groavy
          Buildcon; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Groavy Buildcon. Please include your name, your organization name,
        ...
        <p>No use of Groavy Buildcon's logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>
