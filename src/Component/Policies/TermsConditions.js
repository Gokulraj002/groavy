...
const TermsAndConditions = () => {
  return (
    <div>
      <Helmet>
        <title>
        Groavy Buildcon Terms and Conditions - Policies and Guidelines
        </title>
        <meta
          name="description"
          content='Understand your rights and responsibilities with Groavy. Read our terms and conditions to ensure compliance and informed use of our services.'
        />
        <meta
          name="keywords"
          content="Groavy Buildcon, terms and conditions, policies, guidelines"
        />
        <meta name="author" content="Groavy Buildcon" />
        <meta
          property="og:title"
          content="Groavy Buildcon Terms and Conditions - Policies and Guidelines"
        />
        ...
        <meta
          property="og:url"
          content="https://www.groavy.com/termsandcondition/"
        />
        ...
        <link
          rel="canonical"
          href="https://www.groavy.com/termsandcondition/"
        />
      </Helmet>
      ...
      <section className="section service" id="service" aria-label="service">
        <div className="container mt-5 text-secondary">
          ...
          We will be sending you informative and promotional notifications related to our services via SMS, Emails, WhatsApp, Voice , RCS.
            ...
            continue to use Groavy Buildcon if you do not agree to take all of
          ...
          <p>
            We employ the use of cookies. By accessing Groavy Buildcon, you
            agreed to use cookies in agreement with the Groavy Buildcon's
            Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, Groavy Buildcon and/or its licensors own
            the intellectual property rights for all material on Groavy
            Buildcon. All intellectual property rights are reserved. You may
            access this from Groavy Buildcon for your own personal use subjected
          ...
          <p>
            ...
            Groavy Buildcon does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Groavy Buildcon, its agents and/or affiliates.
            ...
            Groavy Buildcon shall not be liable for the Comments or for any
          ...
          <p>
            Groavy Buildcon reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Groavy Buildcon a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Groavy
            Buildcon; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to Groavy Buildcon. Please include your name, your
          ...
          <p>
            No use of Groavy Buildcon's logo or other artwork will be allowed
